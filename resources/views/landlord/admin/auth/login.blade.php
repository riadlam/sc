...
@section('content')
    ...
    $username = "";
    $password = "";
    if(preg_match('/(novacommerce|hexfashion)/',url('/'))){
            ...
            <div class="auth-form-light text-left p-5">
                ...
                <form class="pt-3" action="#" method="post">
                    <div class="form-group">
                        <input type="email" name="email" class="form-control form-control-lg" value="{{$username}}"
                    ...
                    <div class="mt-3">
                        <button type="submit"
                                ...
                                id="login_submit_btn">{{__('SIGN IN')}}</button>
                    </div>
                    <div class="my-2 d-flex justify-content-between align-items-center">
                        ...
                        @endphp
                        <a href="{{$route}}" class="auth-link text-black">{{__('Forgot password?')}}</a>
                    </div>
                </form>
            </div>
        </div>
