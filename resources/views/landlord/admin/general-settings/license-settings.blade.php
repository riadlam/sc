    ...
    <div class="col-lg-12 col-ml-12">
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title mb-4">{{__("License Settings")}}
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <small>{{__('follow this article to know how you will get your envato purchase code for this script')}}
                                <a href="https://nova.com/where-can-i-find-my-purchase-code-at-codecanyon/" target="_blank">{{__('how to get envato purchase code')}}</a></small>
                        </div>
                    </div>
